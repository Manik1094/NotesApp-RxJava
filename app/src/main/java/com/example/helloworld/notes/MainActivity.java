package com.example.helloworld.notes;
...
import com.example.helloworld.notes.network.model.ApiClient;
import com.example.helloworld.notes.network.model.ApiService;
import com.example.helloworld.notes.network.model.Note;
import com.example.helloworld.notes.network.model.User;
import com.example.helloworld.notes.utils.PrefUtils;
import com.example.helloworld.notes.view.NotesAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  Toolbar toolbar = findViewById(R.id.toolbar);
        ...
        notesAdapter = new NotesAdapter(this, notesList, new NotesAdapter.OnItemClickListener() {
            @Override
    ...
    // registering new user , sending unique id for device identification
        ...
        disposable.add(
                ...
                .subscribeWith(new DisposableSingleObserver<User>(){
                    ...
                    public void onError(Throwable e) {
                        ...
                        Log.e(TAG , " Register Error is : " + e.getMessage());
